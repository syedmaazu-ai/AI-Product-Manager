...
const EXPERIENCE = [
  {
    ...
    company: "Kapture CX",
    sub: "Adjetter Media Network · Bengaluru",
    dates: "Jun 2025 — Present",
    current: true,
    bullets: [
      "Owned the roadmap for GenAI Knowledge Base and Auto-QA product lines, leading 0→1 feature development and driving 30% growth in enterprise adoption across priority accounts.",
      "Evaluated and optimized the GenAI-based FRA solution post-pilot — selected OCR over web scraping and benchmarked multiple LLMs (Gemini 4.0, Llama 4) for accuracy and execution time, ultimately implementing Gemini for optimal performance.",
      "Led the launch of GenAI chatbot solutions across service, transactional, and EMI collection journeys for a major Indian financial services enterprise — achieving 90% chat deflection through prompt orchestration, tool calling, and ERP API integrations.",
      "Delivered 40% faster customer support resolution and 20% CSAT improvement by driving end-to-end rollout of Kapture CX CRM and AI workflows, redesigning CX processes and automation journeys for B2C brands and reducing customer handling time by ~35%.",
    ],
  },
  {
    role: "Associate Product Manager",
    company: "LeadSquared",
    sub: "MarketXpander Services · Bengaluru",
    dates: "May 2024 — Jun 2025",
    bullets: [
      "Owned 3+ Service Cloud workflow modules in a 6-PM pod (SLA, assignment rules, omni-channels), improving routing accuracy and service workflow efficiency.",
      "Led 0→1 delivery of 3 AI features — Recommend-a-Reply, Smart Reply, Tone Selection — reducing manual agent effort by 30%.",
      "Conducted workflow discovery with enterprise clients, translating pain points into prioritized features and roadmap initiatives.",
      "Drove 0→1 onboarding for 20+ clients, prioritizing workflow features to reduce onboarding TAT by 15% and support ₹20L MRR addition across enterprise clients.",
    ],
  },
  {
    role: "Team Lead",
    company: "BYJU'S",
    sub: "Think & Learn · Bengaluru",
    dates: "Jun 2019 — Jun 2022",
    bullets: [
      "Managed 50+ team members using KPI tracking and training plans, improving performance and target achievement metrics.",
      "Analyzed 500+ BYJU'S Neo student insights to identify gaps and influence feature and content roadmap prioritization.",
      "Led a 5-member squad to ship 60+ learning modules, improving learner engagement and product content adoption.",
      "Sustained 9/10 NPS; ranked 5/75 leaders, earned 5× Employee of the Month and fast-track promotion (top 5% performers).",
    ],
  },
];
            ...
            {EXPERIENCE.map((e) => (
              <div className="exp-row" key={e.company}>
                ...
                <div className="exp-main">
                  ...
                  <div className="exp-company">{e.company} <span className="exp-sub">· {e.sub}</span></div>
